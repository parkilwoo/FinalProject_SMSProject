...
public class DateUtil {
	...
	//GameTime 7:00 -> 07:00 변환
   public static String five(String msg){
      return msg.trim().length()<5?"0"+msg:msg.trim();
   }
   
   // nvl 함수
	public static boolean nvl(String msg){		// 다른 곳에서도 사용하려면 utility class 만들어 static함수로 만든다
