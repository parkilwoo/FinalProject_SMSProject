...
<tr style="background-color: #DCE2FF;">
	...
	<c:if test="${game.score1 >= 100 || game.score2 >= 100}">
		<c:if test="${game.game_result == game.name_team1}">
				<p style="font-size: 46px; color: #e60013; display: inline;">${game.score1 }</p><p style="font-size: 46px; display: inline;"> : ${game.score2 }</p>
		</c:if>
		<c:if test="${game.game_result == game.name_team2}">
			<p style="font-size: 46px; display: inline;">${game.score1 } : </p><p style="font-size: 46px; color: #e60013; display: inline;">${game.score2 }</p>
		</c:if>
	</c:if>
	</td>
...
$(document).ready(function(){
	...
	$("#listBtn").click(function() {
		location.href = "gameResultList.do";
	});
