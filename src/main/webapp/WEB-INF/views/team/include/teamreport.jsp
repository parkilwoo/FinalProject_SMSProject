	...
	<div class="form-group" style="margin: auto" align="center">
		...
		<div class="row" align="left" style="margin-top: 5px; margin-left: 120px; font-size: 15px">
			<div style="padding-left: 25px">
				<input type="radio" name="redioSelect" value="홍보성 팀 입니다." id="ch1" class="pointer"> <label for="ch1" class="pointer"
					style="padding-left: 10px; padding-top: 5px;">홍보성 팀 입니다.</label><br>
			</div>
			<div style="padding-left: 25px">
				<input type="radio" name="redioSelect" value="욕설이 심한 팀 입니다." id="ch2" class="pointer"> <label for="ch2" class="pointer"
					style="padding-left: 10px; padding-top: 5px;">욕설이 심한 팀 입니다.</label><br>
			</div>
			<div style="padding-left: 25px">
				<input type="radio" name="redioSelect" value="음란한 팀 입니다." id="ch3" class="pointer"> <label for="ch3" class="pointer"
					style="padding-left: 10px; padding-top: 5px;">음란한 팀 입니다.</label><br>
			</div>
			<div style="padding-left: 25px">
				<input type="radio" name="redioSelect" value="경기에 안나온 팀입니다." id="ch4" class="pointer"> <label for="ch4" class="pointer"
					style="padding-left: 10px; padding-top: 5px;">경기에 안나온 팀입니다.</label><br>
			</div>
			<div style="padding-left: 25px">
				<input type="radio" name="redioSelect" value="비매너 팀 입니다." id="ch5" class="pointer"> <label for="ch5" class="pointer"
					style="padding-left: 10px; padding-top: 5px;">비매너 팀 입니다.</label><br>
			</div>
		</div>
		...
		<button style="margin-top: 15px" class="btn btn-primary" id="_cancel" type="button">취소</button>
	</div>
