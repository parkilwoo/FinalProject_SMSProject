  ...
  <div class="ms_modal-content">
    ...
    <span class="ms_close">&times;</span>
	  ...
	  <div class="form-group">
		  ...
		  <textarea class="form-control" id="_sendContent" placeholder=" 님에게 쪽지 내용을 적어주세요" rows="10" cols="10"></textarea>
 	  </div>
		  <button class="btn btn-primary" onclick="sendMessage()" type="button" class="btn btn-primary">작성 완료</button>
  </div>
...
var r_id;
function _go_send_message(_r_id) {
	r_id = _r_id;
	$("#_sendContent").focus();
	ms_modal.style.display = "block";
	$("#_sendContent").attr("placeholder", r_id + " 님에게 쪽지 내용을 적어주세요");
}
