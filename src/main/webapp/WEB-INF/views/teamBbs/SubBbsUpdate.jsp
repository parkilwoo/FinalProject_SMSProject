			...
			<table class="table table-bordered" style="width: 100%; margin-top: 3%" cellspacing="0">
				...
				<tr>
					...
					<td align="left" style="padding-left: 5px"><select name="subject_category" id="_s_category" style="width: 150px;">
							...
							<option value="용병 구함">용병 구함</option>
							<option value="용병 신청">용병 신청</option>
					</select></td>
				</tr>
				<tr>
					<th>제 &nbsp;&nbsp;&nbsp;&nbsp; 목</th>
					<td align="left" style="padding-left: 5px"><input type="text" name="title" size="50px" class="form-control" value="${bbsdto.title }"></td>
				</tr>
				<tr>
					<th>경기정보</th>
					<td align="left" style="padding-left: 5px"><input type="text" name="game_info" id="fromInput" onclick="getgameList()" size="50px" class="form-control" value="${bbsdto.game_info }"></td>
				</tr>
				<tr>
					<th colspan="2" align="center">내&nbsp;&nbsp;&nbsp;용</th>
				</tr>
				<tr>
					<th colspan="2"><textarea name="content" id="ckeditor">
					${bbsdto.content }
					</textarea></th>
				</tr>
				<tr>
					<td colspan="2" style="text-align: left">
						<button type="button" id="confirm" class="btn btn-primary" >수정하기</button>
...
$("#_s_category").val( "${bbsdto.subject_category}" ).attr("selected","selected");
$("#menu5").css("background-color","#e60013");
	...
	$("#confirm").on('click', function() {
		...
		if (category == "선택") {
			...
			//		alert("제목을 입력해 주세요");
			//		$("#title").focus();
			$("#editorForm").attr('action', 'teamBbsupdate2Af.do').submit();
		}
	});
	...
	$("#cancel").on('click', function() {
		//	alert("취소 클릭");
		var seq = ${bbsdto.seq};
		location.href = '../member/teamBbsdetail2.do?seq='+seq;
	});
	
function getgameList() {
	
	var href = "../common/getgamelist.do";
	window.open(href, '_blank', 'width=1200px,height=700px,toolbars=no,scrollbars=no'); return false;
