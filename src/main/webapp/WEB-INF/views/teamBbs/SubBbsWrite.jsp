			...
			<table class="table table-bordered" style="width: 100%; margin-top: 3%" cellspacing="0">
				...
				<tr>
					...
					<td align="left" style="padding-left: 5px"><select name="subject_category" id="_s_category" style="width: 150px;">
							...
							<option value="매칭 구함">매칭 구함</option>
					</select></td>
				</tr>
				<tr>
					<th>제 &nbsp;&nbsp;&nbsp;&nbsp; 목</th>
				...
				<tr>
					<th>경기정보</th>
					<td align="left" style="padding-left: 5px"><input type="text" name="game_info" id="fromInput" onclick="getgameList()" size="50px" class="form-control"></td>
				</tr>
				<tr>
...
$("#menu5").css("background-color","#e60013");
	...
	$("#confirm").on('click', function() {
		...
		if (category == "선택") {
			...
			$("#editorForm").attr('action', 'BbswriteAf2.do').submit();
		}
	});
