...
<button id="memberappAfBtn">팀원 신청서 보내기</button>
...
<div id="memberappAfModal" class="memberappAfmodal">
  ...
  <div class="memberappAfmodal-content">
    ...
    <table class="table1">
		<tr>
			<td>아이디</td>
			<td><input class="form-control" id="id" type="text" value="${user.username}"></td>
		</tr>
		<tr>
			<td>신청팀</td>
			<td><input class="form-control" id="team_name" type="text" value="${teamdetail.team_name }"></td>
		</tr>
		<tr>
			<td>내용</td>
